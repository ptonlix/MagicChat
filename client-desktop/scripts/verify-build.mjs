...
const messageCacheWorkerPath = path.join(root, "out/main/message-cache-worker.js")
const messageCacheWorker = await readFile(messageCacheWorkerPath, "utf8")
...
assert((await stat(messageCacheWorkerPath)).size > 0, "消息缓存 Worker 产物为空")
